...
author: Stanley
layout: post
guid: http://www.mstz.us/?p=252
permalink: /sun-blade-100-related-to-the-proxy-server-settings-so/
categories:
  - 我的世界
tags:
  - freebsd
...
<div id="toc_container" class="toc_white no_bullets">
  ...
  <ul class="toc_list">
    <li>
      <a href="#cp_GENERIC_proxy">cp GENERIC proxy</a>
    </li>
    <li>
      <a href="#cd_compileproxy">cd ../../compile/proxy</a>
    </li>
    <li>
      <a href="#make_kepend">make kepend</a>
    </li>
    <li>
      <a href="#make">make</a>
    </li>
...
# <span id="cp_GENERIC_proxy">cp GENERIC proxy</span> {#cpgenericproxy}
...
# <span id="cd_compileproxy">cd ../../compile/proxy</span> {#cdcompileproxy}

# <span id="make_kepend">make kepend</span> {#makekepend}

# <span id="make">make</span> {#make}

# <span id="make_install">make install</span> {#makeinstall}
