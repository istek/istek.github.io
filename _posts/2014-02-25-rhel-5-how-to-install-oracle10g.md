...
author: Stanley
layout: post
guid: http://www.mstz.us/?p=1488
permalink: /rhel-5-how-to-install-oracle10g/
categories:
  - 我的世界
tags:
  - RHEL
...
<div id="toc_container" class="toc_white no_bullets">
  ...
  <ul class="toc_list">
    <li>
      <a href="#i">一、安装前的准备工作：</a>
    </li>
    <li>
      <a href="#i-2">二、系统软件</a>
    </li>
    <li>
      <a href="#oracle">三、添加oracle使用的用户和用户组</a>
    </li>
    <li>
      <a href="#i-3">四、创建目录</a>
    </li>
    <li>
      <a href="#oracle-2">五、修改oracle用户的环境变量</a>
    </li>
    <li>
      <a href="#i-4">六、安装</a>
    </li>
    <li>
      <a href="#oracle10groot">七、开启oracle10g的开机自动启动服务（以下都用root身份修改）</a>
    </li>
    <li>
      <a href="#Oracle10g">八、Oracle10g的每天定时自动备份</a>
    </li>
    <li>
      <a href="#oracle10g">九、关于oracle10g的卸载</a>
    </li>
  </ul>
</div>

## <span id="i">一、安装前的准备工作：</span> {#}
...
## <span id="oracle">三、添加oracle使用的用户和用户组</span> {#oracle}
...
## <span id="oracle-2">五、修改oracle用户的环境变量</span> {#oracle}
...
## <span id="oracle10groot">七、开启oracle10g的开机自动启动服务（以下都用root身份修改）</span> {#oracle10groot}
...
## <span id="Oracle10g">八、Oracle10g的每天定时自动备份</span> {#oracle10g}
...
## <span id="oracle10g">九、关于oracle10g的卸载</span> {#oracle10g}
