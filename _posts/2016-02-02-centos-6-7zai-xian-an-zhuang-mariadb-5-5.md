...
author: Stanley
layout: post
guid: http://www.mstz.us/?p=1518
permalink: /centos-6-7zai-xian-an-zhuang-mariadb-5-5/
categories:
  - 我的世界
tags:
  - CentOS
...
<div id="toc_container" class="toc_white no_bullets">
  ...
  <ul class="toc_list">
    <li>
      <a href="#Yum">一、配置Yum源</a>
    </li>
    <li>
      <a href="#i">二、更新软件源</a>
    </li>
    <li>
      <a href="#mariadb">三、安装mariadb数据库</a>
    </li>
    <li>
      <a href="#i-2">四、启动数据库</a><ul>
        <li>
          <a href="#1">1. 启动数据库</a>
        </li>
        <li>
          <a href="#2_root">2. 修改数据库root密码</a>
        </li>
      </ul>
    </li>
    
    <li>
      <a href="#mysql">五、优化mysql数据库</a>
    </li>
  </ul>
</div>

## <span id="Yum">一、配置Yum源</span> {#yum}
...
## <span id="mariadb">三、安装mariadb数据库</span> {#mariadb}
...
## <span id="i-2">四、启动数据库</span> {#}

### <span id="1">1. 启动数据库</span> {#1}

    [root@xia mysql]# service mysql start
    Starting MySQL. SUCCESS!  
    

### <span id="2_root">2. 修改数据库root密码</span> {#2root}
...
## <span id="mysql">五、优化mysql数据库</span> {#mysql}
