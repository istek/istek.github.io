...
author: Stanley
layout: post
guid: http://www.mstz.us/?p=1526
permalink: /using-lets-encrypt-to-encrypt-website/
categories:
  - 我的世界
tags:
  - Debian
...
<div id="toc_container" class="toc_white no_bullets">
  ...
  <ul class="toc_list">
    ...
    <li>
      <a href="#Lets_Encrypt">Let’s Encrypt工作原理</a>
    </li>
    <li>
      <a href="#i-2">操作步骤</a>
    </li>
    ...
    <li>
      <a href="#Lets_Encrypt-2">更新Let’s Encrypt客户端</a>
    </li>
  </ul>
</div>
...
### <span id="Lets_Encrypt">Let’s Encrypt工作原理</span> {#letsencrypt}

![](https://i2.wp.com/assets.digitalocean.com/articles/letsencrypt/nginx-letsencrypt.png?w=720&ssl=1)

### <span id="i-2">操作步骤</span> {#}
...
![](https://i1.wp.com/res.cloudinary.com/the-backyard-of-stanley/image/upload/v1465790723/Obtain-Free-Lets-Encrypt-SSL-Certificate-for-Website_y5trdk.png?w=720&ssl=1)

之后，会根据你的操作系统安装一系列的依赖的软件包，之后会提示你输入EMAIL地址，请注意，必须填写真实，有效的email地址，一旦你丢失了私钥，需要EMAIL来恢复你的key。

![](https://i0.wp.com/assets.digitalocean.com/articles/letsencrypt/le-email.png?w=720&ssl=1)

之后提示你是否同意许可说明，点击回车键（Enter）。

![](https://i0.wp.com/assets.digitalocean.com/articles/letsencrypt/le-agreement.png?w=720&ssl=1)
...
### <span id="Lets_Encrypt-2">更新Let’s Encrypt客户端</span> {#letsencrypt}
