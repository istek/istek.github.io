...
author: Stanley
layout: post
guid: http://www.mstz.us/?p=1274
permalink: /install-ntop-3-4-pre3-under-centos5/
categories:
  - 我的世界
tags:
  - CentOS
...
<div id="toc_container" class="toc_white no_bullets">
  ...
  <ul class="toc_list">
    <li>
      <a href="#i">第一种方法:</a><ul>
        <li>
          <a href="#1ntop">1.安装ntop所必需的开发库和软件</a>
        </li>
        <li>
          <a href="#2Ntop">2.安装Ntop</a>
        </li>
        <li>
          <a href="#3ntop">3.配置ntop</a>
        </li>
      </ul>
    </li>
    
    <li>
      <a href="#i-2">第二种安装方法：</a>
    </li>
  </ul>
</div>

## <span id="i">第一种方法:</span> {#}

### <span id="1ntop">1.安装ntop所必需的开发库和软件</span> {#1ntop}
...
### <span id="2Ntop">2.安装Ntop</span> {#2ntop}
...
### <span id="3ntop">3.配置ntop</span> {#3ntop}
