...
<div class="UBBPanel" style="padding-left: 3px; margin: 15px;">
  <div class="UBBContent">
    #sudo grub <br /> grub>find /boot/grub/stage1 <br /> //之后返回一个数值如  (hd0,6) <br /> (hd0,6) <br /> grub>root(hd0,6) <br /> grub>setup(hd0) <br /> grub>quit
  </div>
</div>
