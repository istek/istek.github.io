...
author: Stanley
layout: post
guid: http://www.mstz.us/?p=1474
permalink: /linux-rhel5-e5-8f-8c-e7-bd-91-e5-8d-a1-e7-bb-91-e5-ae-9a/
categories:
  - 我的世界
tags:
  - RHEL
  - trunk
---
当需要将两块网卡trunk的时候，我们需要做双网卡绑定的操作，其实就是新建了一块虚拟网卡bond0，将两块实际网卡做了它的从设备。从而实现双网卡的trunk模式。
