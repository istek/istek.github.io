...
author: Stanley
layout: post
guid: http://www.mstz.us/?p=1438
permalink: /centos-php-zend-guard/
categories:
  - 我的世界
tags:
  - CentOS
...
在最后位置添加以下内容
    ...
    [Zend Guard] zend_extension=/usr/zend/ZendGuardLoader.so zend_loader.enable=1 zend_loader.disable_licensing=0 zend_loader.obfuscation_level_support=3 zend_loader.license_path=
