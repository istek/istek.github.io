...
author: Stanley
layout: post
guid: http://www.mstz.us/?p=1534
permalink: /upgrade-openssh/
categories:
  - 我的世界
tags:
  - openssh
...
<div id="toc_container" class="toc_white no_bullets">
  ...
  <ul class="toc_list">
    <li>
      <a href="#i">一、安装必须的开发包</a>
    </li>
    <li>
      <a href="#openssh"> 二、下载openssh包</a>
    </li>
    <li>
      <a href="#i-2">三、其他工作（可选）</a>
    </li>
    <li>
      <a href="#openssh-2">四、编译openssh</a>
    </li>
    <li>
      <a href="#i-3"> 五、尝试启动服务</a>
    </li>
  </ul>
</div>

# <span id="i">一、安装必须的开发包</span> {#}
...
# <span id="openssh"> 二、下载openssh包</span> {#openssh}

打开[openssh](http://www.openssh.com/)官方站，下载for linux的tar包，目前最新版本是openssh 7.3p1，请到[openssh_mirror](http://openbsd.hk/pub/OpenBSD/OpenSSH/portable/)站下载。

下载后，上传tar包到服务器的`/usr/src`

# <span id="i-2">三、其他工作（可选）</span> {#}
...
# <span id="openssh-2">四、编译openssh</span> {#openssh}
