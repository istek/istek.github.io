...
author: Stanley
layout: post
guid: http://www.mstz.us/?p=1494
permalink: /config-pdnsd-to-avoid-poisoning/
categories:
  - 我的世界
tags:
  - pdnsd
...
在Windows下，你可以使用[pydnsproxy](http://igfw.net/archives/274)防止DNS污染，在Linux下，可以使用**pdnsd**<sup id="fnref:1"><a href="https://www.bestzhou.org/config-pdnsd-to-avoid-poisoning/#fn:1">1</a></sup>。
...
![首先看到这个](https://i1.wp.com/res.cloudinary.com/the-backyard-of-stanley/image/upload/v1449214654/1449229708_sr9smz.png?w=720)

![选择Manual，在这时pdnsd是不会启动的，需要继续设置](https://i1.wp.com/res.cloudinary.com/the-backyard-of-stanley/image/upload/v1449214653/1449229709_usv2jl.png?w=720)
