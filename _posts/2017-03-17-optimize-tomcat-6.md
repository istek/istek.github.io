---
id: 1540
title: 'tomcat 6/7  优化例子'
date: 2017-03-17T19:03:57+00:00
author: Stanley
layout: post
guid: http://www.mstz.us/?p=1540
permalink: /optimize-tomcat-6/
categories:
  - 我的世界
tags:
  - tomcat
...
<div id="toc_container" class="toc_white no_bullets">
  ...
  <ul class="toc_list">
    <li>
      <a href="#tomcat">tomcat的运行模式</a>
    </li>
    <li>
      <a href="#i">各模式的启用方法</a><ul>
        <li>
          <a href="#1nio">1、nio模式</a>
        </li>
        <li>
          <a href="#2apr">2、apr模式</a>
        </li>
      </ul>
    </li>
  </ul>
...
## <span id="tomcat">tomcat的运行模式</span> {#tomcat}
...
## <span id="i">各模式的启用方法</span> {#}

### <span id="1nio">1、nio模式</span> {#1nio}
...
### <span id="2apr">2、apr模式</span> {#2apr}
...
> _编辑configure文件， 把`$RM "$cfgfile"`这行注释掉，重新编译即可通过。_
